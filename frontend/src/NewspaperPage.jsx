...
export default function NewspaperPage({ teams, rosters, draftedPlayers, initialRookieId, onRookieViewed }) {
  ...
  return (
    <div>
      ...
      <div>
        {page === 1 && <HomePage initialRookieId={initialRookieId} onRookieViewed={onRookieViewed} />}
